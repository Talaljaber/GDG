...
- Later pushes: `20260925000500`/`000600` (ADR-134) and `20260925000700`/`000800` (ADR-136) are on the cloud (2026-09-25); `20260926000100_how_many_retune` (ADR-138) and `20260926000200_swipe_sort_window` (ADR-139) were pushed on 2026-09-26 **before** `main` built the new How Many? bands and the 1100 → 600 ms Swipe Sort window (both only widen the bounds). `migration list --linked` matches local.
